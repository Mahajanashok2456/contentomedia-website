    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto space-y-16 text-gray-700">
          ...
          >
            <p>
              In 2025, your company's digital image matters more than ever. Whether you run a local
              business or an ambitious start-up, negative reviews can damage trust quickly. Your
              online reputation can make or break customer decisions.
            </p>
            <p>
              At <span className="font-semibold text-primary">Contentora Media</span>, we specialise
              in reviews and reputation management services. We help businesses collect authentic
              user feedback, improve satisfaction and respond intelligently to reviews. Using a
              strategic mix of technology and personalised support, we turn customer experiences
          ...
          >
            ...
            <p className="text-sm text-gray-600">* New clients can avail introductory discounts.</p>
          </motion.div>
          ...
          >
            ...
            <p>
              Investing in reviews is not just about improving your star rating. It's about building
              a sustainable reputation strategy. Through consistent collection, monitoring and
              responsiveness, we help increase conversion rates, strengthen search rankings and
              drive brand awareness.
            </p>
            <p>
              We respond to negative reviews with accountability and empathy while amplifying
              positive feedback. We focus on building a reputation that grows with your business as
