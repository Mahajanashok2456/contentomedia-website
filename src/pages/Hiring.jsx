      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto space-y-16 text-gray-700">
          ...
          >
            ...
            <p>
              Whether you're a start-up or an established company, we adapt to your unique needs and
              help you build lasting relationships with hires who contribute to your success.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <span className="font-semibold">Cost-Effective:</span> Hiring that adds value while
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: 'Skilled Professionals', text: 'Access talent across multiple domains.' },
                { title: 'Fresh Ideas', text: 'Interns with innovative thinking and sincerity.' },
                { title: 'Tailored Process', text: 'Customised to your specific business needs.' },
          ...
          >
            ...
            <p>
              Hiring is a partnership where your expertise and vision meet our recruitment precision
              to create teams that are creative, hardworking and ready for tomorrow's opportunities.
            </p>
          </motion.div>
          ...
          >
            ...
            <ol className="list-decimal pl-6 space-y-3">
              ...
              <li>
                <span className="font-semibold">Hiring & Onboarding:</span> Forward suitable resumes
                to your business with detailed offer letters and onboarding support.
              </li>
              <li>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p>
                  Yes. We combine AI filtering with manual review to avoid missing talent and select
                  the right fit.
                </p>
              </div>
              <div>
