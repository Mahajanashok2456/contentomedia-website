    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto space-y-16 text-gray-700">
          ...
          >
            <p>
              An effective SEO strategy is now a top-priority marketing lever. We build SEO programs
              that go beyond rankings—fostering loyalty and retention while maintaining your online
              presence using relevant digital practices.
            </p>
            <p>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <span className="font-semibold">Match Content to Intent:</span> Strategic keywords
                  to appear in relevant results.
                </li>
                <li>
                  <span className="font-semibold">Flawless UX:</span> Optimise speed, security (SSL)
                  and mobile design.
                </li>
                <li>
                  <span className="font-semibold">Compelling Metas:</span> Search snippets that earn
                  more clicks.
                </li>
                <li>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  <span className="font-semibold">Flawless Mobile:</span> Ensure perfect function on
                  phones and tablets.
                </li>
                <li>
                  <span className="font-semibold">Google-Friendly Structure:</span> Crawlability and
