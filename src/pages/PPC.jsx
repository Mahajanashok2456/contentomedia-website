    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-orange-50 via-white to-blue-50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Making the most of site visits with accuracy. Drive qualified traffic with precision and
            maximise value out of every advertising investment.
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto space-y-12 text-gray-700">
          ...
          >
            ...
            <p>
              Are you feeling annoyed because the Return on Investment of your online ads is low? In
              the present competitive online scenario the need to ensure your content gets seen not
              only by more people but also faster has never been higher. Driving qualified traffic
              requires more than just setting up a campaign — it requires precision. At ContentOra
              Media, we drive your internet traffic with Pay-Per-Click (PPC) strategies engineered
              for accuracy.
            </p>
            <p>
          ...
          >
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Competitors engaged in click fraud and your product didn’t find its target audience.
              </li>
          ...
          >
            ...
            <div className="grid gap-6">
              ...
              <div>
                ...
                <p>
                  We craft compelling ad copy and landing pages that attract genuine engagement and
              ...
              <div>
                ...
                <p>
                  We refine relevance, keywords, and landing page experience to lower CPC and expand
                  exposure.
                </p>
              </div>
              <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p>
                  ...
                  where advertisers pay each time targeted ads are clicked. It’s a powerful strategy
