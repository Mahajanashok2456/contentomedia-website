        ...
        <div className="max-w-4xl mx-auto space-y-16 text-gray-700">
          ...
          >
            ...
            <p>
              ...
              goal of creating deep audience relationships. We communicate with clarity, creativity
              and impact.
            </p>
            <p>
              Whether you're establishing an online presence, launching a campaign or strengthening
              social media visibility—our content writing services help build recognition and
              credibility.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p>
                  Product descriptions, ads, sales pages and email marketing copy that stays true to
                  brand values while driving action.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  Strategic integration of keywords in blogs and product descriptions to rank higher
              ...
              <div>
                ...
                <p>
                  Essays, reports and research papers with proper structure, accurate citations and
                  original thought—ideal for students and professionals.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  Original human-written blogs, books and articles under your name—your ideas turned
                  into expertly crafted narratives.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <ul className="grid gap-4 list-none p-0">
              <li className="bg-orange-50 rounded-lg p-4">
                ...
                deliver content that connects with audience and brand value while feeling unique and
                relatable.
              </li>
              ...
              <li className="bg-orange-50 rounded-lg p-4">
                <span className="font-semibold text-secondary">Human-First SEO:</span> We integrate
                keywords naturally so content ranks while staying reader-focused.
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {[
                ...
                { title: 'On Time, Every Time', text: 'We honour deadlines the same as quality.' },
                {
                ...
                <div key={i} className="p-5 rounded-lg shadow-sm bg-gray-50 border border-gray-200">
          ...
          >
            ...
            <p>
              Quality content writing strengthens brand trust, improves search visibility, nurtures
              leads and amplifies conversions across every channel.
            </p>
          </motion.div>
