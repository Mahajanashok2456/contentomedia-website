    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-orange-50 via-white to-lightBlue">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Human-first proofreading that preserves authenticity, eliminates errors and strengthens
            brand credibility.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-16 text-gray-700">
          ...
          >
            ...
            <p>
              ...
              corrections—reviewing tone, structure, consistency and readability. We remove generic
              or AI-sounding fragments and tailor output to your brand.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="p-5 rounded-lg bg-gray-50 border border-gray-200 shadow-sm">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p>
                  Yes. We refine and verify originality. We don’t rewrite AI content—we produce and
                  preserve human work.
                </p>
              </div>
              <div>
          ...
          >
            ...
            <p>
              Get in touch today to make your content shine. No matter your field, we maintain brand
              identity and elevate clarity.
            </p>
            <a
              href="/contact"
