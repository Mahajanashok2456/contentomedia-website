      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto space-y-16 text-gray-700">
          ...
          >
            ...
            <p>
              Our services combine WhatsApp's messaging power with best-in-class digital strategies
              to help your brand connect authentically with its audience.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <span className="font-semibold">Cost-effective ROI:</span> Outreach, engagement and
                retention on a budget with significant returns.
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Instant customer support and faster delivery of brand offers within seconds.</li>
              <li>
                Personalised offers to each customer based on past purchases or interests—automated
                yet human-feeling sequences.
              </li>
              <li>
                Clear call-to-action prompts generate higher click-through and conversion rates than
          ...
          >
            ...
            <ol className="list-decimal pl-6 space-y-3">
              ...
              <li>
                <span className="font-semibold">Set Up:</span> We configure WhatsApp Business (small
                businesses) or WhatsApp Business API (scaling companies), implementing opt-in
                compliance to motivate engagement without bombardment.
              </li>
              <li>
                <span className="font-semibold">Implementation:</span> Build automated yet personal
                conversations—recover abandoned carts, answer FAQs, guide new customers from welcome
                to purchase—using rich multimedia.
              </li>
              <li>
              ...
              <li>
                ...
                click-through, open and conversion rates. Upgrade and refine strategies to steadily
                improve performance.
              </li>
            </ol>
          </motion.div>
          ...
          >
            ...
            <p>
              At Contentora Media, success isn't measured in algorithms alone, but in authenticity.
              We go beyond superficial metrics to understand your story and audience. Our WhatsApp
              Marketing Services amplify your authentic voice and attract believers—ensuring growth
              that's sustainable and true to who you are.
            </p>
            <p>
              Book Contentora Media's WhatsApp Marketing services today to see growth that matters.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p>
                  WhatsApp messages have much higher open rates. People read personal messages more
                  reliably than promotional emails or skippable ads, leading to better engagement
                  and conversions.
                </p>
              </div>
              <div>
                ...
                <p>
                  No. We craft automated yet personal messages using customer data to send relevant,
                  helpful offers and support—not generic blasts.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-secondary">
