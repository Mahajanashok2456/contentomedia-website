...
import { FaQuestion, FaLightbulb, FaShieldAlt, FaRocket, FaUsers, FaFileAlt, FaEdit, FaDollarSign } from 'react-icons/fa';
    ...
    >
      ...
      >
        <motion.div
          ...
          style={{
            backgroundColor: currentColor.icon.includes('#') ? currentColor.icon : undefined,
      ...
      <motion.div
        ...
        style={{
          backgroundColor: currentColor.line.includes('#') ? currentColor.line.match(/#[a-fA-F0-9]+/)?.[0] : undefined
        }}
